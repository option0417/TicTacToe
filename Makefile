...
main: main.o Core.o Evaluation.o BoardView.o \
	IRule.o IsExistRule.o IndexBoundRule.o EvalOverGameRule.o EvalPairValue.o EvalSingleValue.o \
...
# Core fields
#Core: ${OUTPUT}/Core.o ${OUTPUT}/Evaluation.o ${OUTPUT}/BoardView.o \
#	${OUTPUT}/IRule.o ${OUTPUT}/IsExistRule.o ${OUTPUT}/IndexBoundRule.o ${OUTPUT}/EvalOverGameRule.o ${OUTPUT}/EvalPairValue.o ${OUTPUT}/EvalSingleValue.o \
#	${OUTPUT}/IBoard.o ${OUTPUT}/Board.o ${OUTPUT}/IElement.o ${OUTPUT}/Element.o ${OUTPUT}/Common.o

Core.o: ${SRC_PATH}/Core.cpp ${INCLUDE_PATH}/Core.h ${INCLUDE_PATH}/IBoard.h ${INCLUDE_PATH}/IRule.h ${INCLUDE_PATH}/BoardView.h ${INCLUDE_PATH}/Evaluation.h ${INCLUDE_PATH}/Common.h
...
# Rule fields
Rule: IRule.o IsExistRule.o IndexBoundRule.o EvalOverGameRule.o EvalPairValue.o EvalSingleValue.o
...
# Domain fields
Board: IBoard.o Board.o IElement.o Element.o
